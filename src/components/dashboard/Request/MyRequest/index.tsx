...
const MyRequest = () => {
    ...
    const [selectRequerst, setSelectRequest] = useState(null);
    ...
    return (
        <div className="space-y-6">
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                                ...
                                <button
                                    onClick={() => {setOpen(true); setSelectRequest(req)}}
            ...
            <RequestDetailModal request={selectRequerst} open={open} onClose={() => setOpen(false)} />
        </div>
    )
}
